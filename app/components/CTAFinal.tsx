        ...
        {success ? (
          <div className="receipt-card px-8 pt-8 pb-8 mx-auto max-w-md text-left font-mono">
            <div className="text-center mb-4">
              <div className="text-5xl mb-2" style={{ animation: "bounceSoft 1s ease-in-out 3" }}>
                🎉
              </div>
              <h3 className="text-xl font-extrabold text-white font-sans">¡Estás a un paso!</h3>
            </div>
          ...
          >
            <div className="flex items-center justify-between border-b border-dashed border-border pb-4 mb-6">
              <h3 className="text-white font-extrabold text-lg font-mono">Alta de comercio</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
              <div>
                ...
                <input
                  ...
                  placeholder="Juan"
                  required
                  className="w-full bg-surface-container-low border-2 border-border rounded-xl px-4 py-3 text-white placeholder-on-surface-variant/40 focus:outline-none focus:border-primary-light transition-colors min-h-[48px] text-sm"
                />
              </div>
              <div>
                <label className="block text-xs font-semibold text-on-surface-variant/60 uppercase tracking-wider mb-1.5">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full bg-surface-container-low border-2 border-border rounded-xl px-4 py-3 text-white focus:outline-none focus:border-primary-light transition-colors min-h-[48px] text-sm"
                >
            ...
            <button
              type="submit"
              disabled={loading}
              className="btn-primary w-full py-4 rounded-xl text-lg disabled:opacity-60 disabled:cursor-not-allowed hover:scale-[1.02] active:scale-[0.98] transition-transform"
            >
              {loading ? (
